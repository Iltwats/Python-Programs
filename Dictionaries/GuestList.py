...
# friends and how many guests each friend is bringing. Each dictionary is a partial list, but Rory's list has more current information about
# the number of guests.Combine both dictionaries into one, with each friend listed only once, and the number of guests
